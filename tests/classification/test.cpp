...
TEST (centroid, classification_operators) {
    Classification t_operators;
    // clang-format off
    /* centroid at {1, 1} */
    //1  2
    //3  4
...
TEST (intersections, Classification_Operators) {
    Classification To;
...
TEST (distance, Classification_Operators) {
    Classification To;
...
TEST (line_A_B, Classification_Operators) {
    Classification To;
...
TEST (line_X, Classification_Operators) {
    Classification To;
    line_t h_0   = { { 0, 0 }, { 1, 0 } };  // ―
    line_t v_0   = { { 0, 0 }, { 0, 1 } };  // |
    line_t a_45  = { { 0, 0 }, { 1, 1 } };  // ⟋
...
TEST (line_Y, Classification_Operators) {
    Classification To;
    line_t h_0   = { { 0, 0 }, { 1, 0 } };  // ―
    line_t v_0   = { { 0, 0 }, { 0, 1 } };  // |
    line_t a_45  = { { 0, 0 }, { 1, 1 } };  // ⟋
...
TEST (line_intersection, Classification_Operators) {
    Classification To;
...
TEST (is_in_front, Classification_Operators) {
    Classification To;
...
TEST (closest, Classification_Operators) {
    Classification To;
...
TEST (projected_angle_abs, Classification_Operators) {
    Classification To;
...
TEST (dot_product, Classification_Operators) {
    Classification To;
    // horizontal point
...
TEST (translate, Classification_Operators) {
    Classification To;
    // clang-format off
    const points_t base = {
        { 1, { 0, 0 } }, { 2, { 42, 1337 } }
...
TEST (scale, Classification_Operators) {
    Classification To;
    // clang-format off
    const points_t base = {
        { 1, { 0, 1 } }, { 2, { 1, 0 } }
